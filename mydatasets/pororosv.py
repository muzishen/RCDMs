...
class PororosvDataset(Dataset):
    ...
    def __init__(self,
                 ...
                 text_encoder_path,
                 subset='train',
                 h5_file='./datasets/ARLDM/pororo.h5',
                 size=512,
                 text_drop_rate=0.1,
                 length=85,

                 ):
        super(PororosvDataset, self).__init__()
        ...
        msg = self.clip_tokenizer.add_tokens(list([ "pororo", "loopy", "eddy", "harry", "poby", "tongtong", "crong", "rody", "petty" ]))
    ...
    def __getitem__(self, index):
        ...
        if self.sr:
            data_root = './datasets/ARLDM/pororosv_data/train_data_sr'
            for i in range(5):
            ...
            for i in range(5):
                ...
                idx = random.randint(0, im.shape[0] / 128 - 1)  # original papaer codes
